...
glEnd();
	...
	if(ch==0){
		bitmap_output(450,600,"Simulation of spanning tree using Kruskal's Algorithm",GLUT_BITMAP_HELVETICA_18);
	}
	else{
		bitmap_output(500,600,"Simulation of spanning tree using Prim's Algorithm",GLUT_BITMAP_HELVETICA_18);
	}
	glColor3f(0.0,1.0,0.0);
