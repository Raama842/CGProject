...
glEnd();
	...
	if(ch==0){
		bitmap_output(250,650,"Simulation of spanning tree using Kruskal's Algorithm",GLUT_BITMAP_HELVETICA_18);
	}
	else{
		bitmap_output(250,650,"Simulation of spanning tree using Prim's Algorithm",GLUT_BITMAP_HELVETICA_18);
	}
	glColor3f(0.0,1.0,0.0);
	bitmap_output(100,600,"OUTPUT:-",GLUT_BITMAP_TIMES_ROMAN_24);
