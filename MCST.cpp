// mcst.cpp : Defines the entry point for the console application.
//
...
//Global variables
int pointer=10,point=0,line=0,lpointer=0,upointer=-1,undo_cost_stack_pointer=-1;
...
void draw_instructions()
{
	...
	glBegin(GL_LINE_LOOP); 
		glVertex2f(10, height-height/130);
		glVertex2f(130, height-height/130);
	glEnd();
	glColor3f(0.0,0.0,0.0);
...
glColor3f(0.85,0.85,0.85);
	...
	glColor3f(0.0,1.0,0.0);
	bitmap_output(50,595,"OUTPUT --",GLUT_BITMAP_TIMES_ROMAN_24);
	...
	double angle1=10.0;
	glBegin(GL_POLYGON);
	glVertex2d(oldx[i][0]-radius*cos(30.0),radius*sin(30.0)+oldx[i][1]);
	...
	int_str(nodenum,num);
	nodenum++;draw_ins
	bitmap_output(oldx[i][0]-5,oldx[i][1]-6,num,GLUT_BITMAP_HELVETICA_18);
	}
